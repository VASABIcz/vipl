...
impl Lexer {
    pub fn new() -> Self {
        ...
        separators.insert("(".to_string(), Token::Separator(SeparatorType::OpeningRoundBracket));
        separators.insert(")".to_string(), Token::Separator(SeparatorType::ClosingRoundBracket));
        separators.insert("[".to_string(), Token::Separator(SeparatorType::OpeningSquareBracket));
        separators.insert("]".to_string(), Token::Separator(SeparatorType::ClosingSquareBracket));
        separators.insert("{".to_string(), Token::Separator(SeparatorType::OpeningCurlyBracket));
        separators.insert("}".to_string(), Token::Separator(SeparatorType::ClosingCurlyBracket));
    ...
    fn parse_number(self: &mut Self, slice: &str) -> Token {
        match slice.parse::<i32>() {
            Ok(v) => {
                Token::Literal(LiteralType::Int(v))
            }
            Err(_) => {
